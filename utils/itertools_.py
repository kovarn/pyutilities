...
Taken from https://docs.python.org/3.6/library/itertools.html
"""
...
def first_false(iterable, default=True, pred=None):
    """Returns the first false value in the iterable.

    If no false value is found, returns *default*

    If *pred* is not None, returns the first item
    for which pred(item) is false.

    """
    # first_false([a,b,c], x) --> a and b and c and x
